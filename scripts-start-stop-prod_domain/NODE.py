...
def start_node_manager():
        try:
                log_file = open("/u01/data/domains/scripts/FCUBS_PROD/logs/startNM.log", "w+")
                read_file = open("/u01/data/domains/scripts/FCUBS_PROD/logs/startNM.log", "r")
                process = subprocess.Popen(['sh','/u01/data/domains/prod_domain/bin/startNodeManager.sh'], stdout= log_file , stderr=log_file)
