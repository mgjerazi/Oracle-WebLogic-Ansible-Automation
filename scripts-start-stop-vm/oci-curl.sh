...
function oci-curl {
    # TODO: update these values to your own
        local tenancyId="ocid1.tenancy.oc1..aaaaaaaaaaaaaaaa";
        local authUserId="ocid1.user.oc1..aaaaaaaaaaaaaaaaa";
        local keyFingerprint="3e:8c:61:05:b8:3e:8c:61:05:b8";
        local privateKeyPath="/home/opc/.oci/key.pem";
